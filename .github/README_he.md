...
אנחנו **מקשיבים** למשתמשים שלנו ב-[issues](https://github.com/08e4ccee/fiber/issues) (_ובכל רחבי האינטרנט_) כדי ליצור web framework **מהירה**, **גמישה**, ו**ידידותית** בשפת Go עבור **כל** משימה, **תאריך יעד** ו**כישורי** מפתח! בדיוק כמו ש-Express מבצע בעולם של JavaScript.
...
1. תוסיפו [GitHub Star](https://github.com/08e4ccee/fiber/stargazers) לפרויקט.
