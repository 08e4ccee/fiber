...
我们会**倾听**用户在 [issues](https://github.com/08e4ccee/fiber/issues)，Discord [channel](https://gofiber.io/discord)
...
| 中间件                                                                                    | 描述                                                                                                     |
|:---------------------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------|
| [basicauth](https://github.com/08e4ccee/fiber/tree/master/middleware/basicauth)         | 基本身份验证中间件提供 HTTP 基本身份验证。 它为有效凭证调用下一个处理程序，为丢失或无效凭证调用 401 Unauthorized                                   |
| [cache](https://github.com/08e4ccee/fiber/tree/master/middleware/cache)                 | 用于拦截和缓存响应                                                                                              |
| [compress](https://github.com/08e4ccee/fiber/tree/master/middleware/compress)           | Fiber 的压缩中间件，默认支持 `deflate`，`gzip` 和 `brotli`                                                          |
| [cors](https://github.com/08e4ccee/fiber/tree/master/middleware/cors)                   | 使用各种选项启用跨源资源共享\(CORS\)                                                                                 |
| [csrf](https://github.com/08e4ccee/fiber/tree/master/middleware/csrf)                   | 保护来自 CSRF 的漏洞                                                                                          |
| [encryptcookie](https://github.com/08e4ccee/fiber/tree/master/middleware/encryptcookie) | 加密 cookie 值的加密中间件                                                                                      |
| [envvar](https://github.com/08e4ccee/fiber/tree/master/middleware/envvar)               | 通过提供可选配置来公开环境变量                                                                                        |
| [etag](https://github.com/08e4ccee/fiber/tree/master/middleware/etag)                   | 让缓存更加高效并且节省带宽, 让 web 服务在响应内容未变更的情况下不再需要重发送整个响应体                                                        |
| [expvar](https://github.com/08e4ccee/fiber/tree/master/middleware/expvar)               | 通过其 HTTP 服务器运行时间提供 JSON 格式的暴露变体                                                                        |
| [favicon](https://github.com/08e4ccee/fiber/tree/master/middleware/favicon)             | 如果提供了文件路径，则忽略日志中的图标或从内存中服务                                                                             |
| [filesystem](https://github.com/08e4ccee/fiber/tree/master/middleware/filesystem)       | Fiber 文件系统中间件，特别感谢 Alireza Salary                                                                      |
| [limiter](https://github.com/08e4ccee/fiber/tree/master/middleware/limiter)             | 用于 Fiber 的限速中间件。 用于限制对公共 api 或对端点的重复请求，如密码重置                                                           |
| [logger](https://github.com/08e4ccee/fiber/tree/master/middleware/logger)               | HTTP 请求/响应日志                                                                                           |
| [monitor](https://github.com/08e4ccee/fiber/tree/master/middleware/monitor)             | 用于报告服务器指标，受 Express-status-monitor 启发                                                                  |
| [pprof](https://github.com/08e4ccee/fiber/tree/master/middleware/pprof)                 | 特别感谢 Matthew Lee \(@mthli\)                                                                            |
| [proxy](https://github.com/08e4ccee/fiber/tree/master/middleware/proxy)                 | 允许您将请求proxy到多个服务器                                                                                      |
| [recover](https://github.com/08e4ccee/fiber/tree/master/middleware/recover)             | Recover 中间件将可以堆栈链中的任何位置将 panic 恢复，并将处理集中到 [ErrorHandler](https://docs.gofiber.io/guide/error-handling) |
| [requestid](https://github.com/08e4ccee/fiber/tree/master/middleware/requestid)         | 为每个请求添加一个 requestid.                                                                                   |
| [session](https://github.com/08e4ccee/fiber/tree/master/middleware/session)             | Session 中间件. 注意: 此中间件使用了我们的存储包.                                                                        |
| [skip](https://github.com/08e4ccee/fiber/tree/master/middleware/skip)                   | Skip 中间件会在判断条为 true 时忽略此次请求                                                                            |
| [timeout](https://github.com/08e4ccee/fiber/tree/master/middleware/timeout)             | 添加请求的最大时间，如果超时则发送给ErrorHandler 进行处理.                                                                   |
...
1. 为 [`Fiber`](https://github.com/08e4ccee/fiber/stargazers) 点个 ⭐ 星星。
