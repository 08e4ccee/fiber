...
نحن **نصغي** لمستخدمينا [issues](https://github.com/08e4ccee/fiber/issues), نناقش [channel](https://gofiber.io/discord) _وفي جميع أنحاء الإنترنت_ لإنشاء **سريع**, **مرن** و **مألوف** Go إطار الويب لـ **لأي** مهمة, **الموعد الأخير
...
1. اضف [GitHub نجمة](https://github.com/08e4ccee/fiber/stargazers) للمشروع.
...
Copyright (c) 2019-present [Fenny](https://github.com/fenny) and [Contributors](https://github.com/08e4ccee/fiber/graphs/contributors). `Fiber` هو برنامج مجاني ومفتوح المصدر مرخص بموجب [MIT License](https://github.com/08e4ccee/fiber/blob/master/LICENSE). تم إنشاء الشعار الرسمي من قبل [Vic Shóstak](https://github.com/koddr) ووزعت تحت [Creative Commons](https://creativecommons.org/licenses/by-sa/4.0/) رخصة (CC BY-SA 4.0 International).
