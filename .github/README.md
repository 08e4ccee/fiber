...
We **listen** to our users in [issues](https://github.com/08e4ccee/fiber/issues), Discord [channel](https://gofiber.io/discord) _and all over the Internet_ to create a **fast**, **flexible** and **friendly** Go web framework for **any** task, **deadline** and developer **skill**! Just like Express does in the JavaScript world.
...
| [skip](https://github.com/08e4ccee/fiber/tree/master/middleware/skip)                   | Skip middleware that skips a wrapped handler if a predicate is true.                                                                                                         |
...
1. Add a [GitHub Star](https://github.com/08e4ccee/fiber/stargazers) to the project.
