...
<p align="center">
  <b>Fiber</b> — це <b>веб фреймворк</b>, який був натхненний <a href="https://github.com/expressjs/express">Express</a>
  і заснований на <a href="https://github.com/valyala/fasthttp">Fasthttp</a>, найшвидшому HTTP-двигунові написаному на
  <a href="https://go.dev/doc/">Go</a>. Фреймворк розроблено з метою <b>спростити</b> процес <b>швидкої</b> розробки
  <b>високопродуктивних</b> веб-додатків з <b>нульовим розподілом пам'яті</b>.
</p>
...
<details>
  <summary>📚 Показати більше прикладів коду</summary>
...
| Middleware                                                                             | Опис                                                                                                                                                                             |
| :------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [basicauth](https://github.com/08e4ccee/fiber/tree/master/middleware/basicauth)         | Middleware який забезпечує базову автентифікацію по HTTP.                                                                                                                        |
| [cache](https://github.com/08e4ccee/fiber/tree/master/middleware/cache)                 | Middleware який перехоплює та кешує відповіді                                                                                                                                    |
| [compress](https://github.com/08e4ccee/fiber/tree/master/middleware/compress)           | стиснення для Fiber, воно за замовчуванням підтримує `deflate`, `gzip` і `brotli`.                                                                                               |
| [cors](https://github.com/08e4ccee/fiber/tree/master/middleware/cors)                   | Middleware який вмикає перехресне використання ресурсів \(CORS\) із різними параметрами.                                                                                         |
| [csrf](https://github.com/08e4ccee/fiber/tree/master/middleware/csrf)                   | Захист від експлойтів CSRF.                                                                                                                                                      |
| [encryptcookie](https://github.com/08e4ccee/fiber/tree/master/middleware/encryptcookie) | Шифрування значень файлів cookie.                                                                                                                                                |
| [envvar](https://github.com/08e4ccee/fiber/tree/master/middleware/envvar)               | Middleware для відкриття змінних середевищ.                                                                                                                                      |
| [etag](https://github.com/08e4ccee/fiber/tree/master/middleware/etag)                   | Middleware яке робить кеш-пам’ять більш ефективним і заощаджує пропускну здатність, оскільки веб-серверу не потрібно повторно надсилати повну відповідь, якщо вміст не змінився. |
| [expvar](https://github.com/08e4ccee/fiber/tree/master/middleware/expvar)               | Middleware який обслуговує доступні варіанти середовища виконання HTTP у форматі JSON.                                                                                           |
| [favicon](https://github.com/08e4ccee/fiber/tree/master/middleware/favicon)             | Ігнорування значка із журналів або обслуговувати з пам’яті, якщо вказано шлях до файлу.                                                                                          |
| [filesystem](https://github.com/08e4ccee/fiber/tree/master/middleware/filesystem)       | Middleware файлової системи, особлива подяка та кредити Alireza Salary.                                                                                                          |
| [limiter](https://github.com/08e4ccee/fiber/tree/master/middleware/limiter)             | Ообмеження швидкості для Fiber. Використовуйте для обмеження повторних запитів до загальнодоступних API та/або кінцевих точок, таких як скидання пароля.                         |
| [logger](https://github.com/08e4ccee/fiber/tree/master/middleware/logger)               | Реєстратор запитів/відповідей HTTP.                                                                                                                                              |
| [monitor](https://github.com/08e4ccee/fiber/tree/master/middleware/monitor)             | Middleware який повідомляє показники сервера.                                                                                                                                    |
| [pprof](https://github.com/08e4ccee/fiber/tree/master/middleware/pprof)                 | Особлива подяка Метью Лі \(@mthli\) .                                                                                                                                            |
| [proxy](https://github.com/08e4ccee/fiber/tree/master/middleware/proxy)                 | Дозволяє надсилати проксі-запити до кількох серверів.                                                                                                                            |
| [recover](https://github.com/08e4ccee/fiber/tree/master/middleware/recover)             | Middleware який відновлює паніки будь-де в ланцюжку стека та передає керування централізованому [обробнику помилок](https://docs.gofiber.io/guide/error-handling).               |
| [requestid](https://github.com/08e4ccee/fiber/tree/master/middleware/requestid)         | До кожного запиту додає ідентифікатор запиту.                                                                                                                                    |
| [session](https://github.com/08e4ccee/fiber/tree/master/middleware/session)             | Middleware для сеансів. ПРИМІТКА: Цей middleware використовує наш пакет зберігання.                                                                                              |
| [skip](https://github.com/08e4ccee/fiber/tree/master/middleware/skip)                   | Middleware який пропускає упакований обробник, якщо предикат є істинним.                                                                                                         |
| [timeout](https://github.com/08e4ccee/fiber/tree/master/middleware/timeout)             | Додає максимальний час для запиту та пересилає до ErrorHandler, якщо його перевищено.                                                                                            |
...
1. Додайте [зірку GitHub](https://github.com/08e4ccee/fiber/stargazers) до проекту.
...
Авторське право (c) 2019-дотепер [Fenny](https://github.com/fenny) та [Contributors](https://github.com/08e4ccee/fiber/graphs/contributors). `Fiber` це безкоштовне програмне забезпечення з відкритим вихідним кодом, ліцензоване згідно [MIT License](https://github.com/08e4ccee/fiber/blob/master/LICENSE). Офіційний логотип створено [Vic Shóstak](https://github.com/koddr) і поширюється під [Creative Commons](https://creativecommons.org/licenses/by-sa/4.0/) ліцензією (CC BY-SA 4.0 International).
