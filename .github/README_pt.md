...
| :------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [basicauth](https://github.com/08e4ccee/fiber/tree/master/middleware/basicauth)         | Autenticação básica fornece uma autenticação HTTP básica. Ele chama o próximo manipulador para credenciais válidas e 401 Não Autorizado para credenciais ausentes ou inválidas. |
| [cache](https://github.com/08e4ccee/fiber/tree/master/middleware/cache)                 | Intercepta e armazena em cache as respostas                                                                                                                                     |
| [compress](https://github.com/08e4ccee/fiber/tree/master/middleware/compress)           | Middleware de compressão para o Fiber, suporta `deflate`, `gzip` e `brotli` por padrão.                                                                                         |
| [cors](https://github.com/08e4ccee/fiber/tree/master/middleware/cors)                   | Habilita o compartilhamento de recursos de origem cruzada (CORS) com várias opções.                                                                                             |
| [csrf](https://github.com/08e4ccee/fiber/tree/master/middleware/csrf)                   | Protege contra exploits CSRF.                                                                                                                                                   |
| [encryptcookie](https://github.com/08e4ccee/fiber/tree/master/middleware/encryptcookie) | Criptografa valores de cookie.                                                                                                                                                  |
| [envvar](https://github.com/08e4ccee/fiber/tree/master/middleware/envvar)               | Expõe variáveis de ambiente fornecendo uma configuração opcional.                                                                                                               |
| [etag](https://github.com/08e4ccee/fiber/tree/master/middleware/etag)                   | Permite que caches sejam mais eficientes e economizem largura de banda, pois um servidor web não precisa reenviar uma resposta completa se o conteúdo não mudou.                |
| [expvar](https://github.com/08e4ccee/fiber/tree/master/middleware/expvar)               | Serve via seu servidor HTTP variantes expostas em tempo de execução no formato JSON.                                                                                            |
| [favicon](https://github.com/08e4ccee/fiber/tree/master/middleware/favicon)             | Ignora favicon dos logs ou serve da memória se um caminho de arquivo for fornecido.                                                                                             |
| [filesystem](https://github.com/08e4ccee/fiber/tree/master/middleware/filesystem)       | Sistema de Arquivos para o Fiber, agradecimentos especiais e créditos a Alireza Salary                                                                                          |
| [limiter](https://github.com/08e4ccee/fiber/tree/master/middleware/limiter)             | Limitação de taxa para o Fiber. Use para limitar solicitações repetidas para APIs públicas e/ou endpoints como redefinição de senha.                                            |
| [logger](https://github.com/08e4ccee/fiber/tree/master/middleware/logger)               | Logger de solicitação/resposta HTTP.                                                                                                                                            |
| [monitor](https://github.com/08e4ccee/fiber/tree/master/middleware/monitor)             | Middleware de monitoramento que relata métricas do servidor, inspirado pelo express-status-monitor                                                                              |
| [pprof](https://github.com/08e4ccee/fiber/tree/master/middleware/pprof)                 | Agradecimentos especiais a Matthew Lee (@mthli)                                                                                                                                 |
| [proxy](https://github.com/08e4ccee/fiber/tree/master/middleware/proxy)                 | Permite que você faça proxy de solicitações a vários servidores                                                                                                                 |
| [recover](https://github.com/08e4ccee/fiber/tree/master/middleware/recover)             | Recupera de panics em qualquer lugar da cadeia de chamadas e passa o controle para o [ErrorHandler](https://docs.gofiber.io/guide/error-handling) centralizado.                 |
| [requestid](https://github.com/08e4ccee/fiber/tree/master/middleware/requestid)         | Adiciona um ID de solicitação a cada pedido.                                                                                                                                    |
| [session](https://github.com/08e4ccee/fiber/tree/master/middleware/session)             | Middleware de sessão. NOTA: Este middleware usa nosso pacote Storage.                                                                                                           |
| [skip](https://github.com/08e4ccee/fiber/tree/master/middleware/skip)                   | Pula um handler envolto se um predicado for verdadeiro.                                                                                                                         |
| [timeout](https://github.com/08e4ccee/fiber/tree/master/middleware/timeout)             | Adiciona um tempo máximo para uma solicitação e encaminha para ErrorHandler se ele for excedido.                                                                                |
...
1. Deixe uma [estrela no GitHub](https://github.com/08e4ccee/fiber/stargazers) do projeto.
...
Todos os direitos reservados (c) 2019-presente [Fenny](https://github.com/fenny) e [Contribuidores](https://github.com/08e4ccee/fiber/graphs/contributors).
`Fiber` é software livre e aberto sob a [licença MIT](https://github.com/08e4ccee/fiber/blob/master/LICENSE).
