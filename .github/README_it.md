...
<details>
  <summary>📚 Mostra altri esempi</summary>
...
| :------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [basicauth](https://github.com/08e4ccee/fiber/tree/master/middleware/basicauth)         | Middleware basico di autenticazione usando http. Chiama il suo handler se le credenziali sono giuste e il codice 401 Unauthorized per credenziali mancanti o invalide.                      |
| [cache](https://github.com/08e4ccee/fiber/tree/master/middleware/cache)                 | Intercetta e mette nella cache la risposta                                                                                                                                                  |
| [compress](https://github.com/08e4ccee/fiber/tree/master/middleware/compress)           | Middleware di compressione per Fiber, supporta `deflate`, `gzip` e `brotli` di default.                                                                                                     |
| [cors](https://github.com/08e4ccee/fiber/tree/master/middleware/cors)                   | Ti permette di usare cross-origin resource sharing \(CORS\) con tante opzioni.                                                                                                              |
| [csrf](https://github.com/08e4ccee/fiber/tree/master/middleware/csrf)                   | Ti protegge da attachi CSRF.                                                                                                                                                                |
| [encryptcookie](https://github.com/08e4ccee/fiber/tree/master/middleware/encryptcookie) | Middleware che encrypta i valori dei cookie.                                                                                                                                                |
| [envvar](https://github.com/08e4ccee/fiber/tree/master/middleware/envvar)               | Esporre le variabili di ambiente fornendo una configurazione facoltativa.                                                                                                                   |
| [etag](https://github.com/08e4ccee/fiber/tree/master/middleware/etag)                   | Middleware che permette alle cache di essere più efficienti e salvare banda, come un web server che non deve rimandare il messagio pieno se il contenuto non è cambiato.                    |
| [expvar](https://github.com/08e4ccee/fiber/tree/master/middleware/expvar)               | Middleware che serve via il suo runtime server HTTP varianti esposte in formato JSON.                                                                                                       |
| [favicon](https://github.com/08e4ccee/fiber/tree/master/middleware/favicon)             | Ignora favicon dai logs o serve dalla memoria se un filepath è specificato.                                                                                                                 |
| [filesystem](https://github.com/08e4ccee/fiber/tree/master/middleware/filesystem)       | Middleware per il FileSystem per Fiber, grazie tante e crediti a Alireza Salary                                                                                                             |
| [limiter](https://github.com/08e4ccee/fiber/tree/master/middleware/limiter)             | Middleware per Rate-limiting per Fiber. Usato per limitare richieste continue agli APIs publici e/o endpoints come un password reset.                                                       |
| [logger](https://github.com/08e4ccee/fiber/tree/master/middleware/logger)               | Logger HTTP per richiesta/risposta.                                                                                                                                                         |
| [monitor](https://github.com/08e4ccee/fiber/tree/master/middleware/monitor)             | Middleware per monitorare che riporta metriche server, ispirato da express-status-monitor                                                                                                   |
| [pprof](https://github.com/08e4ccee/fiber/tree/master/middleware/pprof)                 | Grazie tante a Matthew Lee \(@mthli\)                                                                                                                                                       |
| [proxy](https://github.com/08e4ccee/fiber/tree/master/middleware/proxy)                 | Ti permette di fare richieste proxy a multipli server.                                                                                                                                      |
| [recover](https://github.com/08e4ccee/fiber/tree/master/middleware/recover)             | Middleware per recuperare dagli attachi di panico da tutte le parti nella stack chain e affida il controllo al [ ErrorHandler](https://docs.gofiber.io/guide/error-handling) centralizzato. |
| [requestid](https://github.com/08e4ccee/fiber/tree/master/middleware/requestid)         | Aggiunge un requestid a ogni richiesta.                                                                                                                                                     |
| [session](https://github.com/08e4ccee/fiber/tree/master/middleware/session)             | Middleware per sessioni. NOTA: Questo middleware usa il nostro Storage package.                                                                                                             |
| [skip](https://github.com/08e4ccee/fiber/tree/master/middleware/skip)                   | Middleware che salta un wrapped handler se un predicate è vero.                                                                                                                             |
| [timeout](https://github.com/08e4ccee/fiber/tree/master/middleware/timeout)             | Aggiunge un tempo massimo per una richiesta e lo manda a ErrorHandler se si supera.                                                                                                         |
...
1. Aggiungi una [stella GitHub](https://github.com/08e4ccee/fiber/stargazers) al progetto.
...
Copyright (c) 2019-ora [Fenny](https://github.com/fenny) e [Contributors](https://github.com/08e4ccee/fiber/graphs/contributors). `Fiber` è un software free e open-source licenzato sotto [MIT License](https://github.com/08e4ccee/fiber/blob/master/LICENSE). Il logo ufficiale è stato creato da [Vic Shóstak](https://github.com/koddr) e distribuito sotto licenza [Creative Commons](https://creativecommons.org/licenses/by-sa/4.0/) (CC BY-SA 4.0 International).
