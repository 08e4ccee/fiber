...
```bash
go get github.com/08e4ccee/fiber/v2
```
...
We created a custom `CopyString` function that does the above and is available under [gofiber/utils](https://github.com/08e4ccee/fiber/tree/master/utils).
...
For more information, please check [**\#426**](https://github.com/08e4ccee/fiber/issues/426) and [**\#185**](https://github.com/08e4ccee/fiber/issues/185).
