...
Returns the matched [Route](https://pkg.go.dev/github.com/08e4ccee/fiber?tab=doc#Route) struct.
...
:::tip
You can find all used status codes and messages [here](https://github.com/08e4ccee/fiber/blob/dffab20bcdf4f3597d2c74633a7705a517d2c8c2/utils.go#L183-L244).
:::
