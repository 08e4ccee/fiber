...
EnvVar middleware for [Fiber](https://github.com/08e4ccee/fiber) that can be used to expose environment variables with various options.
...
import (
  ...
  "github.com/08e4ccee/fiber/v2/middleware/envvar"
)
```
