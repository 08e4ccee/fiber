...
Proxy middleware for [Fiber](https://github.com/08e4ccee/fiber) that allows you to proxy requests to multiple servers.
...
import (
    ...
    "github.com/08e4ccee/fiber/v2/middleware/proxy"
)
```
