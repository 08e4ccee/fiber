...
The Early Data middleware for [Fiber](https://github.com/08e4ccee/fiber) adds support for TLS 1.3's early data ("0-RTT") feature.
...
import (
	...
	"github.com/08e4ccee/fiber/v2/middleware/earlydata"
)
```
